<template> 
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#F6D2A2"
    ...
    <path
        ...
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#C6B198" d="M21.1 68.7c.5-.2 1.1-.3 1.4-.8"
        clip-path="url(#go-original-b)"></path>
    <path
        d="M21.1 69c-.1 0-.3-.1-.3-.2-.1-.2 0-.4.2-.4.1 0 .2-.1.2-.1.4-.2.8-.3 1-.6.1-.1.3-.2.5-.1.1.1.2.3.1.5-.4.5-.9.7-1.3.8l-.2.1h-.2z"
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#6AD7E5" d="M29.3 26.4c-13.6-3.8-3.5-21.1 7.4-14l-7.4 14z"
    ...
    <path
        ...
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#6AD7E5" d="M89.6 11.1c10.7-7.5 20.5 9.5 8 13.8l-8-13.8z"
        clip-path="url(#go-original-b)"></path>
    <path
    ...
    <path
        ...
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#C6B198" d="M107.1 68.2c-.5-.2-1.1-.3-1.4-.8"
        clip-path="url(#go-original-b)"></path>
    <path
        d="M107.1 68.6h-.1l-.2-.1c-.5-.2-1-.3-1.3-.8-.1-.1-.1-.4.1-.5.1-.1.4-.1.5.1.2.3.6.4 1 .6.1 0 .2.1.2.1.2.1.3.3.2.4-.1.1-.3.2-.4.2z"
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#6AD7E5"
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#fff"
        d="M65.2 22.2c2.4 14.2 25.6 10.4 22.3-3.9-3-12.8-23.1-9.2-22.3 3.9" clip-path="url(#go-original-b)"></path>
    <path
        ...
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#fff"
        d="M37.5 24.5c3.2 12.3 22.9 9.2 22.2-3.2-.9-14.8-25.3-12-22.2 3.2" clip-path="url(#go-original-b)"></path>
    <path
    ...
    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#fff"
        d="M45.2 23.3c0 .5-.4.9-.8.9s-.8-.4-.8-.9.4-.9.8-.9c.5 0 .8.4.8.9" clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <path fill="#231F20"
        ...
        clip-path="url(#go-original-b)"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M58.6 32.1c-.2-4.7 8.8-5.3 9.8-1.4 1.1 4-9.4 4.9-9.8 1.4"
        clip-path="url(#go-original-b)"></path>
</svg>
</template>